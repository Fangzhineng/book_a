...
class MainTopDetailActivity : BaseActivity<ActivityMianTopDetailBinding>() {

    private var id: Int = 0

    private val adapter:MainTopDetailAdapter = MainTopDetailAdapter(this)

    fun startActivity(context: Context, id: Int ?) {
        val intent: Intent = Intent()
        intent.putExtra("id", id)
        intent.setClass(context, MainTopDetailActivity::class.java)
        context.startActivity(intent)
    }

    private val mainTopDetailVM:MainTopDetailViewModel by lazy {
        ViewModelProviders.of(this).get(MainTopDetailViewModel::class.java)
    }
